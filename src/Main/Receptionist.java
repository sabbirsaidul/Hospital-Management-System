...
public class Receptionist extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mLabel.setBackground(new java.awt.Color(102, 153, 255));
        mLabel.setFont(new java.awt.Font("Times New Roman", 1, 30)); // NOI18N
        mLabel.setForeground(new java.awt.Color(255, 255, 255));
        mLabel.setText("Hospital Management System");

        dUser.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        plbl.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        ...
        rExitBtn.setBackground(new java.awt.Color(102, 153, 255));
        ...
        rLoginBtn.setBackground(new java.awt.Color(102, 153, 255));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(190, 190, 190)
                .addComponent(mLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 580, javax.swing.GroupLayout.PREFERRED_SIZE))
            .addGroup(layout.createSequentialGroup()
                .addGap(262, 262, 262)
                .addComponent(dUser)
                .addGap(15, 15, 15)
